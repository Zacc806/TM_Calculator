...
export const translations: Record<Lang, Dict> = {
  ru: {
    ...
    "result.otbasyNote":
      "Расчёт приблизительный: Otbasy — двухфазная программа, точные суммы в отделе продаж.",
    "result.standardNote":
    ...
    "action.consult": "Консультация с менеджером",
  ...
  kk: {
    ...
    "result.otbasyNote":
      "Есеп шамамен: Otbasy — екі фазалы бағдарлама, нақты сомалар сату бөлімінде.",
    "result.standardNote":
      "Есеп шамамен.",
    ...
    "action.consult": "Менеджермен кеңес алу",
  ...
  en: {
    ...
    "result.otbasyNote":
      "Estimate: Otbasy is a two-phase program; exact figures are with the sales department.",
    "result.standardNote":
      "Estimate only.",
    ...
    "action.consult": "Talk to a manager",
